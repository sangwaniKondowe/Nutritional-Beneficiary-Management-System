  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          {['Dashboard', 'Beneficiaries',].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon>{index % 2 === 0 ? <DashboardIcon /> : <PermIdentityIcon />}</ListItemIcon>
              <ListItemText primary={text} />
            </ListItem>
          ))}
        
          {['Programs', 'Users'].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon>{index % 2 === 0 ? <ExtensionIcon /> : <PeopleIcon />}</ListItemIcon>
              <ListItemText primary={text} />
            </ListItem>
          ))}
        </List>
