...
import { Typography, Grid, Paper,InputBase, TextField } from '@material-ui/core';
...
const programs = [
  ...
  function createData(name, ID, Program, Age, Sex) {
    return { name, ID, Program, Age, Sex };
  }
  ...
  const rows = [
    ...
    createData('Nougat', 'MW56746', 'Nutrition & under 5', 9, 37.0),
  ...
  const headCells = [
    { id: 'name', numeric: false, disablePadding: true, label: 'All names' },
    { id: 'ID', numeric: true, disablePadding: false, label: 'National ID Number' },
            ...
            <Grid container spacing={3} direction='column' >
                <Grid item xs={12} >
                    ...
                    <Grid container  direction='row' spacing={1} alignItems='center'>
                        ...
                        <Grid  item xs={4} className={classes.programPos} >
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="start">{row.Program}</TableCell>
